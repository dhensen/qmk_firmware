...
#define L3_CAPS LT(MO(2), KC_CAPS)
#define L2_LEFT LT(MO(2), KC_LEFT)
#define L1_DOWN LT(MO(1), KC_DOWN)
#define RCTL_RGHT LT(KC_RCTL, KC_RGHT)
#define RSFT_UP LT(KC_RSFT, KC_UP)
